...
//})
//public class UserServiceConsumerTest_6_WithBodyAsDslRequestINPact {
//
//  @Autowired
//  private UserClient userClient;
//
//  @Pact(provider = "userservice", consumer = "userclient")
//  public RequestResponsePact createPersonbuPact(PactDslWithProvider builder) {
...
//                    .stringType("firstName","Wrong Name")
