...
public class UserServiceConsumerTest_9_AddEmbededDto {
    ...
    public void verifyCreatePersonPact() {
        ...
        IdObject id = userClient.createUser(new RequestWrapperDto<>(user), headers);
    ...
    public void verifyCreatePersonPactReactiveFeign() {
        ...
        user.setFirstName("Zaphod");
        user.setLastName("Beeblebrox");
        StepVerifier.create(reactiveUserClient.createUser(new RequestWrapperDto<>(user), headers))
                .assertNext(id -> {
                    assertEquals(id.getId(), 42);
                }).verifyComplete();
    }
    ...
    public void verifyCreatePersonPactWebClient() {
        ...
        var idObjectMono = webClient
                ...
                .body(BodyInserters.fromValue(new RequestWrapperDto(user)))
                .retrieve()
