...
//})
//public class UserServiceConsumerTest_14_AddArrayToFifthDto {
//
//    @Autowired
...
//                                                .stringValue("firstName", "Zaphod")
//                                                .stringValue("lastName", "Beeblebrox"))
//                                        .object("user3", new PactDslJsonBody()
//                                                .stringValue("firstName", "Zaphod")
//                                                .stringValue("lastName", "Beeblebrox"))
//                                        .object("user4", new PactDslJsonBody()
//                                                .minArrayLike("user4",1)
//                                                .stringValue("firstName", "Zaphod")
//                                                .stringValue("lastName", "Beeblebrox"))
//                                        .object("user5", new PactDslJsonBody()
//                                                .array("user5")
//                                                .object()
//                                                .stringValue("firstName", "Zaphod")
//                                                .stringValue("lastName", "Beeblebrox")
...
//
//
//        IdObject id = userClient.createCar(new RequestWrapperDto<>(new Car(user, user,user, List.of(user), List.of())), headers);
...
//        user.setFirstName("Zaphod");
//        user.setLastName("Beeblebrox");
//        StepVerifier.create(reactiveUserClient.createCar(new RequestWrapperDto<>(new Car(user, user,user,List.of(user), List.of())), headers))
//                .assertNext(id -> {
//                    assertEquals(id.getId(), 42);
//                }).verifyComplete();
//    }
...
//                .body(BodyInserters.fromValue(new RequestWrapperDto(new Car(user, user,user,List.of(user), List.of()))))
//                .retrieve()
